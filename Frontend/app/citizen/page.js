...
function CitizenDashboardContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { report, gamification, classification } = res.data;
      ...
      const confidenceText = classification?.aiPowered
        ? ` (AI Confidence: ${classification.confidencePercent}%)`
        : '';
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
              ...
              {aiResult && (
                <div className={`mt-6 p-5 rounded-xl border-2 ${
                  aiResult.wasteType === 'Wet' ? 'border-green-400 bg-green-50 dark:bg-green-900/20' :
                  aiResult.wasteType === 'Dry' ? 'border-blue-400 bg-blue-50 dark:bg-blue-900/20' :
                  aiResult.wasteType === 'E-Waste' ? 'border-orange-400 bg-orange-50 dark:bg-orange-900/20' :
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-bold text-xl">{aiResult.wasteType} Waste</p>
                    </div>
                    <div>
                        ...
                        <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                          <div
                            className={`h-2 rounded-full transition-all duration-700 ${
                              aiResult.confidencePercent >= 70 ? 'bg-green-500' :
                              aiResult.confidencePercent >= 40 ? 'bg-yellow-500' : 'bg-orange-500'
                            }`}
                            style={{ width: `${aiResult.confidencePercent || 0}%` }}
                          />
                        </div>
                        <span className="font-bold text-sm">{aiResult.confidencePercent || 0}%</span>
                      </div>
                    </div>
                  </div>
